...
<head>
    ...
    <link href="<?=base_url('assets/adminbsb/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css')?>" rel="stylesheet" />
    ...
    <link href="<?=base_url('assets/adminbsb/css/themes/all-themes.css')?>" rel="stylesheet" />
     ...
     <!-- Custom oth Css -->
    <link href="<?=base_url('assets/adminbsb/css/custom.css')?>" rel="stylesheet">

    <!-- Sweetalert Css -->
    <link href="<?=base_url('assets/adminbsb/plugins/sweetalert/sweetalert.css')?>" rel="stylesheet" />
